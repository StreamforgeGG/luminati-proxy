...
### Windows
Download the [Proxy Manager installer](https://github.com/luminati-io/luminati-proxy/releases/download/v1.564.78/luminati-proxy-manager-v1.564.78-setup.exe)
